...
public class GuiDai extends GuiContainer {
    private TileEntityDai tileEntity;
    private static final ResourceLocation GUITEXTURE = new ResourceLocation(MODID, "textures/gui/dai.png");

    public GuiDai(EntityPlayer player, TileEntityDai tileEnttiy) {
        super(new ContainerDai(player, tileEnttiy));
