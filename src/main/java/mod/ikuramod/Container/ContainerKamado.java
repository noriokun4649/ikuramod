...
public class ContainerKamado extends Container {
     ...
     * クイックスロットの第一スロットの番号
     */
    private static final int index2 = 31;
    /**
     * このコンテナの全体のスロット数
     */
    private static final int index3 = 40;

    public ContainerKamado(EntityPlayer player, TileEntityKamado tileEntity) {
        this.tileEntity = tileEntity;
        tileEntity.openInventory(player);
        this.addSlotToContainer(new Slot(tileEntity, 0, 140, 17));
        this.addSlotToContainer(new Slot(tileEntity, 1, 140, 53));
        this.addSlotToContainer(new Slot(tileEntity, 2, 80, 35));
        this.addSlotToContainer(new Slot(tileEntity, 3, 8, 53));
