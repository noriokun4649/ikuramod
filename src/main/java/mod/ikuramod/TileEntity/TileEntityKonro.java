...
public class TileEntityKonro extends TileEntity implements IInventory {
    private NonNullList<ItemStack> itemStacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
